nic_cards = {
  ...
  # }
  nic_4 = {
    nic_card_name       = "main_switch-1_linux-vm-nic"
    location            = "centralindia"
    resource_group_name = "project_time_machine"
    config_name         = "main_switch_config"
    subnet_id           = "/subscriptions/a112f499-171d-4e54-bb69-e2536fa4c7af/resourceGroups/project_time_machine/providers/Microsoft.Network/virtualNetworks/power_unit/subnets/main_switch"
  ...
  nic_5 = {
    nic_card_name       = "main_switch-2_linux-vm-nic"
    location            = "centralindia"
    resource_group_name = "project_time_machine"
    config_name         = "main_switch_config"
    subnet_id           = "/subscriptions/a112f499-171d-4e54-bb69-e2536fa4c7af/resourceGroups/project_time_machine/providers/Microsoft.Network/virtualNetworks/power_unit/subnets/main_switch"
...
os_resources = {
  ...
  #   }
  # }
  main_switch-1_linux_vm = {
    vm_name             = "mainswitch-1"
    location            = "centralindia"
    resource_group_name = "project_time_machine"
    nic_id              = "/subscriptions/a112f499-171d-4e54-bb69-e2536fa4c7af/resourceGroups/project_time_machine/providers/Microsoft.Network/networkInterfaces/main_switch-1_linux-vm-nic"
    vm_size             = "Standard_B2ats_v2"
    ...
    storage_os_disk = {
      name              = "main_switch-1_linux_vm_os_disk"
      caching           = "ReadWrite"
      create_option     = "FromImage"
      managed_disk_type = "Standard_LRS"
    }
    os_profile = {
      computer_name  = "Main-Switch-1"
      admin_username = "devopsadmin"
      admin_password = "devopsadmin@123"
    }
  }
  main_switch-2_linux_vm = {
    vm_name             = "mainswitch-2"
    location            = "centralindia"
    resource_group_name = "project_time_machine"
    nic_id              = "/subscriptions/a112f499-171d-4e54-bb69-e2536fa4c7af/resourceGroups/project_time_machine/providers/Microsoft.Network/networkInterfaces/main_switch-2_linux-vm-nic"
    vm_size             = "Standard_B2ats_v2"
    ...
    storage_os_disk = {
      name              = "main_switch-2_linux_vm_os_disk"
      caching           = "ReadWrite"
      create_option     = "FromImage"
      managed_disk_type = "Standard_LRS"
    }
    os_profile = {
      computer_name  = "Main-Switch-2"
      admin_username = "devopsadmin"
      admin_password = "devopsadmin@123"
    }
  }
